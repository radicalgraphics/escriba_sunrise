...
var Dajaxice = {
    ...
    get_course: function(callback_function, argv, custom_settings){
        return Dajaxice.call('qubalapp.get_course', 'POST', callback_function, argv, custom_settings);
    },
    ...
    multiply: function(callback_function, argv, custom_settings){
        return Dajaxice.call('qubalapp.multiply', 'POST', callback_function, argv, custom_settings);
    },
...
,
    ...
    call: function(dajaxice_function, method, dajaxice_callback, argv, custom_settings)
    {
        ...
        var send_data = 'argv='+encodeURIComponent(JSON.stringify(argv)),
            ...
            endpoint = '/test/dajaxice/'+dajaxice_function+'/';
